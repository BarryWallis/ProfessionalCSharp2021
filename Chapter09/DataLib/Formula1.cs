...
{
    private static List<Racer>? _racers = null;
    public static IList<Racer> GetChampions() => _racers ??= InitializeRacers();
    ...
    private static List<Team>? _teams = null;
    public static IList<Team> GetConstructorChampions() => _teams ??= new()
    {
        new("Vanwall", 1958),
        new("Cooper", 1959, 1960),
        new("Ferari", 1961, 1964, 1975, 1976, 1977, 1979, 1982, 1983, 1999, 2000, 2001, 2002, 2003, 2004, 2007, 2008),
        new("BRM", 1962),
    ...
    public static IEnumerable<Championship> GetChampionships() => _championships ??= new()
    {
